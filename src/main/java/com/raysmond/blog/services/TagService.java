...
public class TagService {
    ...
    private static final String CACHE_NAME = "cache.tag";
    private static final String CACHE_NAME_TAGS = "cache.tag.all";
    private static final String CACHE_TYPE = "'_Tag_'";
    private static final String CACHE_KEY = CACHE_TYPE + " + #tagName";
    private static final String CACHE_TAG_KEY = CACHE_TYPE + " + #tag.name";
